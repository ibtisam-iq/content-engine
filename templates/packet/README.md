...
| :--- | :--- | :--- | :--- |
| `channels/linkedin.md` | `linkedin` | `post` | `draft` |
| `channels/x.md` | `x` | `post` | `draft` |
| `channels/facebook.md` | `facebook` | `post` | `draft` |
| `channels/blog.md` | `blog` | `article` | `draft` |
| `channels/newsletter.md` | `newsletter` | `newsletter` | `draft` |
